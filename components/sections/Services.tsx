...
function ServiceCard({
  ...
  return (
    <div
      ...
      className={cn(
        "reveal group relative rounded-2xl p-6 glass border border-border hover:border-[rgba(201,168,76,0.18)] transition-all duration-400 overflow-hidden",
        inView && "visible"
      )}
    ...
    >
      ...
      <div
        ...
        style={{
          background: `radial-gradient(ellipse at top left, rgba(${hexToRgb(service.accent)}, 0.07), transparent 60%)`,
        }}
      />
      ...
      <div className="relative flex items-start justify-between mb-5">
        ...
        <div className="text-right">
          ...
          <div className="font-sans text-[10px] tracking-widest uppercase text-text-muted mt-0.5">
            {service.statLabel}
          </div>
        </div>
      </div>
      ...
      <div className="relative space-y-2.5">
        <h3 className="font-display text-lg md:text-xl font-medium text-text tracking-wide group-hover:text-gold transition-colors duration-300">
          {service.title}
        </h3>
      ...
      {/* Bottom arrow */}
      <div
        className="relative mt-5 flex items-center gap-2 font-sans text-xs tracking-widest uppercase opacity-0 group-hover:opacity-100 transition-opacity duration-300"
        style={{ color: service.accent }}
      >
        <span>Explore</span>
    ...
    <section id="services" className="section relative overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
        ...
        <div
          ...
          className={cn("reveal mb-10 md:mb-14 max-w-2xl", headInView && "visible")}
        >
          ...
          <p className="font-sans text-text-muted text-base md:text-lg leading-relaxed">
            Six integrated disciplines. One unified vision. From first concept
            to final cut.
          </p>
        </div>
